const headings = {
  ...
  existingTokens: { heading: 'Connecting contarct of tokens', subheading: 'The owner of this contract will be considered the owner of the created project' },
  ...
  successfullTransaction: 'Transaction sended succesfull',
